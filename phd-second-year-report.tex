...
%
In these systems, collective objectives must be realised by multiple distributed devices whose connectivity, availability, and position may change at runtime.
%
This makes it difficult to rely on centralized coordination or on solutions in which device roles and communication patterns are fixed in advance.
%
...
%Building on the research carried out during the first year, the second-year activity focused on developing and evaluating mechanisms that address specific requirements of collective robotic applications.
%
%The work on self-stabilizing gossip investigates resilient distributed coordination in the presence of failures and topology changes; the work on Distributed Particle Filtering studies how sensing and state estimation can be organized collectively and adapted at runtime; the research carried out at Mälardalen University introduces control-theoretic safety guarantees for aggregate-programmed robot swarms; and the ongoing extension of FieldVMC investigates the generation of more structured collective formations.
...
%
The objective is to use these mechanisms to guide morphogenetic growth towards more complex artificial structures in simulation while preserving the decentralized and self-organizing nature of the original approach.
...
The mechanisms developed during the PhD are intended to contribute progressively to these libraries rather than remain isolated implementations tied to individual experiments.
%
%In particular, reusable results emerging from the work on gossip, distributed estimation, morphogenesis, and collective robotics can become higher-level building blocks available to other Collektive applications.
...
During the next year, I plan to continue the main research directions developed so far.
%
...
%
This will make it possible to evaluate distributed estimation together with heterogeneous sensing and collective motion in scenarios that are closer to realistic deployments.
